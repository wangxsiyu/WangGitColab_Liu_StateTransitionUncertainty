...
class TwoStepTask:
    ...
    def possible_switch(self, switch_p=0.05):
    ...
    def reset(self):
        ...
        p_input = np.concatenate((state, np.array([0, 0]), [0], [self.timestep]))
        return p_input
    ...
    def step(self, action):
        ...
        p_input = np.concatenate((state, action1, [reward], [self.timestep]))
        return p_input, reward, done, self.timestep